<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index-section.aspx.cs" Inherits="TUP_Laboratorio_3_Tp_Final.index_section" %>
...
<body>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a
              ...
              href="./resources/html/offers-section.html"
              id="offers-section"
              >Ofertas</a
            >
          </li>
          <li class="nav-item">
            <a
              class="nav-link active"
              href="./resources/html/request-section.html"
              id="request-section"
          ...
          <li class="nav-item">
            <a
              class="nav-link active"
              href="./resources/html/products-section.html"
              id="products-section"
              >Productos</a
            >
          </li>
          <li class="nav-item">
            <a
              class="nav-link active"
              href="./resources/html/contact-section.html"
              id="contact-section"
              >Contacto</a
            >
          </li>
    ...
    <main class="mt-4">
      ...
      <div class="home pagina">
        ...
        <div>
          <img
            src="./resources/images/home-banner.jpg"
            class="img--home"
